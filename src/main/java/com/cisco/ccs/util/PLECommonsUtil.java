...
//
//import com.cisco.ple.exception.InvalidPLEPropertyException;
//import com.cisco.ple.holder.SkuUpdateFlagHolder;
import com.cisco.ccs.i18n.I18NResourceHandler;
//import com.cisco.ple.model.content.Course;
//import com.cisco.ple.model.order.OrderResponse;
//import com.cisco.ple.model.search.SearchCriteria;
//import com.cisco.ple.model.skumanagement.sku.DkitMaster;
//import com.cisco.ple.model.usermanagement.CCOUser;
//import com.cisco.ple.service.PLEServiceConstants;

public final class PLECommonsUtil {
    ...
    public static final boolean isNullOrEmpty(Set value) {
        if (value == null || value.isEmpty()) {
            return true;
        }
        return false;
